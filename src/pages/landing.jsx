...
const LandingPage = () => {
  ...
  return (
    <div className='flex flex-col items-center'>
      ...
      <img className='w-full my-11 md:px-11' src='./banner.jpeg' alt='banner image'/>
      <Accordion type="multiple" collapsible className="w-full md:px-11">
        ...
        <AccordionItem value="item-3">
          ...
          <AccordionContent>
            You can view the number of clicks, geolocation data of the clocks and device types (mobile/desktop) for each of your shortened URLs.
          </AccordionContent>
        </AccordionItem>
      </Accordion>
    </div>
